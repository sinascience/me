  ...
  const contactMethods = [
    {
      icon: Mail,
      label: "Email",
      value: "anis.fajar.dev@gmail.com",
      href: "mailto:anis.fajar.dev@gmail.com",
      color: "text-blue-400",
    ...
    <section id="contact" className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      >
        ...
        <p className="text-xl text-zinc-400 max-w-3xl mx-auto">
          Ready to bring your ideas to life with scalable, professional solutions. 
      ...
      <div className="grid lg:grid-cols-2 gap-12">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h3 className="text-2xl font-bold text-zinc-200 mb-8">Get In Touch</h3>
          ...
          <div className="space-y-6 mb-12">
            {contactMethods.map((method, index) => (
              ...
              >
                <div className={`p-3 rounded-lg bg-zinc-800 ${method.color} mr-4 group-hover:scale-110 transition-transform duration-300`}>
                  <method.icon className="h-6 w-6" />
                </div>
                <div className="flex-1">
                  <h4 className="font-semibold text-zinc-200 mb-1">{method.label}</h4>
                  <p className="text-zinc-300 font-mono text-sm">{method.value}</p>
          ...
          <div className="bg-zinc-900/30 border border-zinc-800 rounded-xl p-6">
            <h4 className="text-lg font-semibold text-zinc-200 mb-4">Availability</h4>
        ...
        >
          <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-8">
            <h3 className="text-2xl font-bold text-zinc-200 mb-6">Send a Message</h3>
            ...
            <form className="space-y-6">
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="w-full px-8 py-4 bg-gradient-to-r from-blue-500 to-indigo-500 text-white rounded-lg font-medium flex items-center justify-center gap-2 hover:shadow-lg transition-all duration-300"
              >
