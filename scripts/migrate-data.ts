...
async function main() {
  ...
  await prisma.project.create({
    data: {
      ...
      description:
        "Comprehensive healthcare management platform serving as the digital backbone for Indonesia's growing skin clinic chain. This enterprise-level application manages everything from patient consultations to inventory management across multiple locations.",
      image: "/dashboard.png",
        ...
        create: [
          {
            ...
            description:
              "Redesigned and stabilized in-app consultation feature with 90% reliability improvement",
            impact:
              "Enhanced user satisfaction through seamless patient-provider communication",
            order: 1,
          },
          {
            title: "Complete UI/UX Revamp",
            description:
              "Migrated from static Twig pages to dynamic Next.js application",
            impact:
              "Significant SEO improvements and enhanced client-side performance",
            order: 2,
          },
          {
            title: "Database Architecture Modernization",
            description:
              "Implemented multi-database architecture with Redis caching",
            impact:
              "60% reduction in database load and improved response times",
            order: 3,
          },
          {
            title: "Code Quality Initiative",
            description:
              "Pioneered clean code practices across entire codebase",
            impact:
              "40% reduction in technical debt through systematic refactoring",
            order: 4,
          },
        ],
      },
    ...
    data: [
      {
        ...
        description:
          "Modern React, Next.js, TypeScript, and Angular applications with exceptional user experiences",
        icon: "Code2",
      ...
      },
      {
        ...
        description:
          "Scalable PHP, Laravel, Go Fiber, and Node.js solutions handling enterprise-level traffic",
        icon: "Server",
      ...
      },
      {
        ...
        description:
          "MySQL, PostgreSQL, Redis, MongoDB - Optimized for performance and scalability",
        icon: "Database",
      ...
      },
      {
        ...
        description:
          "Google Cloud Platform, AWS, Docker deployment and infrastructure management",
        icon: "Cloud",
      ...
      },
      {
        ...
        description:
          "Payment gateways, chat systems, video calling, and third-party service integrations",
        icon: "Layers",
      ...
      },
      {
        ...
        description:
          "60% query optimization, caching strategies, and scalable architecture design",
        icon: "Zap",
      ...
      },
      {
        ...
        description:
          "Healthcare application security, HIPAA considerations, and best practices implementation",
        icon: "Shield",
  ...
  await prisma.experience.create({
    data: {
      ...
      type: "Current Role",
      description:
        "Leading technical architecture and development for Hayyu Skin Clinic's comprehensive ERP system, serving as the main technical decision-maker.",
      color: "from-blue-400 to-indigo-500",
      order: 1,
      achievements: {
        create: [
  ...
  await prisma.experience.create({
    data: {
      ...
      type: "Growth Phase",
      description:
        "Core developer for building and maintaining the Hayyu Skin Clinic ERP system, focusing on full-stack development while mastering enterprise technologies.",
      color: "from-green-400 to-emerald-500",
      order: 2,
      achievements: {
        create: [
  ...
  await prisma.experience.create({
    data: {
      ...
      type: "Foundation",
      description:
        "Intensive training program focusing on modern web development frameworks and database management, establishing foundation for full-stack career.",
      color: "from-purple-400 to-pink-500",
      order: 3,
      achievements: {
        create: [
